...
export function summarizePrompt(messages: Message[], ids: string[], summary: string) {
  ...
  return {
    ...
    prompt: `Progressively summarize the lines of conversation provided, adding onto the previous
      summary recrning a new summary but INCLUDE DETAILED OUTPUT OF AI REPLIES SO THAT AI CAN BUILD UPON PREVIOUS CONVERSATIONS AND GIVE A MORE DETAILED OUTPUT OF FOCUSSED TOPIC.
